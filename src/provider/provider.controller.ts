...
export class ProviderController {
    ...
    async createScholershipContent(@Request() request,@Body() createContentdto?:CreateContentDto){
        console.log("user", request.user);
        console.log("createContentdto", createContentdto);
        this.logggerService.log('POST /createContent',request.user.id);
        return this.providerService.createScholershipContent(request.user,createContentdto)
    }
    ...
    @Patch('/content/:id')
    @UseGuards(AuthGuard("jwt"), new RoleGuard("provider"))
    async editScholershipContent(@Request() request,@Param('id') id, @Body() createContentdto?:CreateContentDto){
        console.log("createContentdto", createContentdto);
